...
# Oracle WebLogic 10.3 SP2 on EL5 kickstart stub
...
# url --url=$tree
url --url==http://192.168.249.102/cobbler/ks_mirror/centos54-dist-x86_64
...
$SNIPPET('el5/post/sun/java/16/linux/x86_64/16017_jdk')
$SNIPPET('el5/post/oracle/wls/10/linux/x86_64/software/1032')
